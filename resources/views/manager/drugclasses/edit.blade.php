                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form id="myForm" method="POST"
                                        action="{{ route('manager.update.drug.class', ['id' => $drugclass->id]) }}"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-select" id="classification_id"
                                                    ...
                                                    <option value="{{ $drugclass->classification_id }}" selected>
                                                        {{ $drugclass->classification->classification }}</option>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-10">
                                                <input class="form-control" id="drug_classification_name" name="name"
                                                    type="text" value="{{ $drugclass->name }}"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-10">
                                                <textarea class="form-control" id="description" name="description" cols="10" rows="5"
                                                    placeholder="Description">{{ $drugclass->description }}</textarea>
                                            </div>
                                        </div>
