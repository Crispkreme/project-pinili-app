                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <a class="nav-link mb-2"
                                                ...
                                                data-bs-toggle="pill"
                                                href="{{ route('admin.get.company.profile') }}"
                                                role="tab"
                                        ...
                                        <div class="col-md-9">
                                            <div class="tab-content text-muted mt-4 mt-md-0" id="v-pills-tabContent">
                                                <div class="tab-pane active fade show" id="v-pills-order-history" role="tabpanel" aria-labelledby="v-pills-order-history-tab">
    ...
    <script>
        $(document).ready(function () {
            $('a[data-bs-toggle="pill"]').on('shown.bs.tab', function (e) {
                ...
                } else if (e.target.id === 'v-pills-company-profile-tab') {
                    console.log('click company profile tab');
                } else {
